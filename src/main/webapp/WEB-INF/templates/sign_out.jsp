...
<html>
    <head>
        ...
        <title><fmt:message bundle="${particular}" key="sign.out.title" /></title>
        <link rel="stylesheet" type="text/css" href="/static/css/main.css">
    </head>
    <body>
        <h1><fmt:message bundle="${particular}" key="sign.out.h1" /></h1>
        <h3><fmt:message bundle="${particular}" key="sign.out.h3" /></h3>
        <hr>
