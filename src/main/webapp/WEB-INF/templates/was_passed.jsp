...
<fmt:setBundle basename="/i18n/was_passed" var="bundle" scope="session" />
<html>
<head>
...
<div class="navigation-menu">
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/available"><fmt:message bundle="${bundle}" key="available" /></a>
    </nav>
</div>
</body>
</html>
