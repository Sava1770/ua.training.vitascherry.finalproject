...
<%@ taglib uri="/WEB-INF/tag/contains.tld" prefix="fn" %>
<html>
<head>
        ...
        <table>
            ...
            <c:forEach var="answer" items="${question.answers}" varStatus="inner">
                <tr class="answer-body">
                    <td class="answer-text"><c:out value="${inner.index + 1}. "/><c:out value="${answer.text}"/></td>
                    <td class="flag">
                        <c:if test="${fn:contains(requestScope.answers, answer)}">
                            <c:choose>
