...
-- -----------------------------------------------------
-- Table final_project.user_answer
-- -----------------------------------------------------
DROP TABLE IF EXISTS final_project.user_answer ;

CREATE TABLE IF NOT EXISTS final_project.user_answer (
  id_answer INT(11) NOT NULL,
  id_user INT(11) NOT NULL,
  PRIMARY KEY (id_answer, id_user),
  INDEX user_answer_id_answer_fk_idx (id_user ASC),
  CONSTRAINT user_answer_id_answer_fk
    FOREIGN KEY (id_answer)
    REFERENCES final_project.answer (id_answer)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT user_answer_id_user_fk
    FOREIGN KEY (id_user)
