...
<fmt:setBundle basename="/i18n/signin" var="bundle" scope="session" />
<html>
    <head>
            ...
            <form method="POST" action="${pageContext.request.contextPath}/signin" autocomplete="on">
                <table>
                    <c:if test="${requestScope.isInvalidCredentials}">
                        <tr>
                            <td colspan="2" class="invalid"><fmt:message bundle="${bundle}" key="invalid" /></td>
                        </tr>
                    </c:if>
                    <tr>
                    ...
                    <tr>
                        <td><label for="password"><fmt:message bundle="${bundle}" key="password" /></label></td>
